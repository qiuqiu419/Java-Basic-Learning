...
public class LittleSuperMarket {
    ...
    public com.geekbang.supermarket.MerchandiseV2[] merchandises;
    ...
    public LittleSuperMarket(String superMarketName, String address, int parkingCount,
        ...
        merchandises = new com.geekbang.supermarket.MerchandiseV2[merchandiseCount];
        for (int i = 0; i < merchandises.length; i++) {
            double purchasePrice = Math.random() * 200;
            // 创建并给商品的属性赋值
            com.geekbang.supermarket.MerchandiseV2 m = new com.geekbang.supermarket.MerchandiseV2(
                    "商品" + i,
                    "ID" + i,
                    count,
    ...
    public void setMerchandises(com.geekbang.supermarket.MerchandiseV2[] merchandises) {
     ...
     * @return
     */
    public com.geekbang.supermarket.MerchandiseV2 getBiggestProfitMerchandise() {
        com.geekbang.supermarket.MerchandiseV2 curr = null;
        for (int i = 0; i < merchandises.length; i++) {
            com.geekbang.supermarket.MerchandiseV2 m = merchandises[i];
            // 这个逻辑有问题吗？相同的利润怎么判断？
